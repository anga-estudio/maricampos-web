...
interface EditProgramButtonProps {
  program: Program;
}

export default function EditProgramButton({ program }: EditProgramButtonProps) {
  ...
  return (
    <>
      <button
        ...
        className="px-4 py-2 text-sm text-green border border-green/20 rounded-lg hover:bg-green/5 transition-colors"
      >
        Editar
      </button>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-2xl p-8 w-full max-w-md shadow-xl">
            <h2 className="text-2xl font-light text-green mb-6">Editar Programa</h2>
